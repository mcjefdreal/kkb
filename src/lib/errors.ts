...
const ERROR_MESSAGES: Record<string, string> = {
	...
	'Contribution must be between 0 and the bill total': 'Contribution must be between 0 and the bill total',
	'Contribution would exceed remaining bill total': 'Contribution would exceed the remaining bill total',
	'Room is not open for settlement': 'Room is not open for settlement',
	'Total contributions must equal the bill total': 'Total contributions must equal the bill total',
	...
	'Only the payer can unmark this payment': 'Only the payer can unmark this payment',
	'Only pending-confirmation payments can be unmarked': 'Only pending-confirmation payments can be unmarked',
